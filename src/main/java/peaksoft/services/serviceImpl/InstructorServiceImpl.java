...
public class InstructorServiceImpl implements InstructorService {
    ...
    @Override
    public SimpleResponse saveInstructor(Long companyId, InstructorRequest instructorRequest) {
    ...
    public InstructorResponseGetStudents getStudentCountFromInstructor(Long instructorId) {
        ...
        return instructorRepository.getStudentCountFromInstructor(instructorId).orElseThrow( ()-> new NotFoundException("not found"));
    }

    @Override
    public InstructorResponseInfo getInstructorInfo(Long instructorId) {
        return instructorRepository.getInstructorInfo(instructorId).orElseThrow( ()-> new NotFoundException("Instructor with id:"+instructorId+ " not found..."));
    }
